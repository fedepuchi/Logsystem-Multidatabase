...
> **Pendiente:** Documentar todos los parámetros de cada endpoint y agregar ejemplos de solicitudes y respuestas.
...
> **Pendiente:** Agregar resultados de las pruebas realizadas por el equipo.

---

# Capturas del Sistema

> **Pendiente:** Agregar imágenes del Dashboard.

> **Pendiente:** Agregar imágenes del visor de logs.

> **Pendiente:** Agregar imágenes del cambio de conexión.
...
| Nombre | Rol |
|---------|-----|
| Abdul Rodríguez | Documentación / README |
| Pendiente | Backend |
| Pendiente | Frontend |
...
Antes de la entrega final se deben completar las siguientes secciones:

- URL del repositorio GitHub.
- Variables de entorno definitivas.
- Capturas del sistema funcionando.
- Ejemplos completos de la API.
